...
const regex3 = /(\d){1,4}-(\d){1,2}-(\d){1,2}/;
console.log(`regex matches 2000-10-12: ${regex3.test('2000-10-12')}`);
console.log(`regex matches 1999-1-20: ${regex3.test('1999-1-20')}`);
console.log(`regex matches 1999-01-20: ${regex3.test('1999-01-20')}`);
console.log(`regex matches 812-2-10: ${regex3.test('812-2-10')}`);
// 2000-10-12
// 1999-1-20
// 1999-01-20
// 812-2-10